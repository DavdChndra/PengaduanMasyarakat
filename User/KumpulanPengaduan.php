...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body shadow sticky-top py-3 px-2">
        <div class="container-fluid">
            <a class="navbar-brand" href="http://localhost/OnlineShop/index.php/user">Kumpulan Pengaduan Masyarakat</a>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-black" aria-current="page" data-bs-toggle="modal"
                                data-bs-target="#IDPenduduk" style="cursor:pointer;">
    ...
    <div class="container">
        <div class="mt-5">
            ...
            if (isset($_POST['search'])){
                $cari = $_POST['cari'];
                $query_result = mysqli_query($host, "SELECT* from tb_input_aspirasi where nama like '%$cari%' OR jenis_aspirasi like '%$cari%' 
                OR id_penduduk ='$cari' OR rating like '%$cari%' OR lokasi like '%$cari%' OR tanggal like '%$cari%' ORDER BY id_pelaporan DESC");		
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="rating my-1">
                            ...
                            <?php
                                ...
                                if($data['rating'] == null) {?>
                            <label class="py-2 px-3 rounded bg-danger text-white fw-semibold">
                                Pengadu Belum Memberikan Penilaian
                            </label>
